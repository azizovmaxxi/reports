...
function getReport(req, res){
  res.render('reports/rpt52/report_52');
}
...
async function _lpu_report(req, res) {
  ...
  let sqlResult = await DB.EXEC_ASYNC("rpt_52", params.sqlParams);

  res.render('reports/rpt52/rpt_52_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
  getReport_52: getReport,
  resReport_52: resReport
};