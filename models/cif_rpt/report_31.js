...
function getReport(req, res){
    res.render('reports/rpt31/report_31');
}
    ...
    try
    {
        ...
        switch(getRole(req.user)){
            case 'lpu':
                ...
                break;
            case 'republic':
                throw "For current role don't report_31";
...
async function _lpu_report(req, res) {
    ...
    let sqlResult = await DB.EXEC_ASYNC("rpt_31", params.sqlParams);

    res.render('reports/rpt31/rpt_31_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
    getReport_31: getReport,
    resReport_31: resReport
};