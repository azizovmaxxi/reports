...
function getReport(req, res){
  res.render('reports/rpt49/report_49');
}
...
async function _lpu_report(req, res) {
  ...
  let sqlResult = await DB.EXEC_ASYNC("rpt_49", params.sqlParams);
  res.render('reports/rpt49/rpt_49_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
  getReport_49: getReport,
  resReport_49: resReport
};