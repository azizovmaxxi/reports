...
function getReport(req, res){
    res.render('reports/rpt56/report_56');
}
...
async function _lpu_report(req, res) {
    ...
    let sqlResult = await DB.EXEC_ASYNC("rpt_56", params.sqlParams);

    res.render('reports/rpt56/rpt_56_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
