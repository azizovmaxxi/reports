...
function getReport(req, res){
  res.render('reports/rpt55/report_55');
}
...
async function _lpu_report(req, res) {
  ...
  let sqlResult = await DB.EXEC_ASYNC("rpt_55", params.sqlParams);

  res.render('reports/rpt55/rpt_55_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
  getReport_55: getReport,
  resReport_55: resReport
};