...
function getReport(req, res){
    res.render('reports/rpt10/report_10');
}
...
async function _lpu_report(req, res) {
    ...
    let sqlResult = await DB.EXEC_ASYNC("rpt_10", params.sqlParams);
    res.render('reports/rpt10/rpt_10_result', {layout: false, data:sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
    getReport_10: getReport,
    resReport_10: resReport
};