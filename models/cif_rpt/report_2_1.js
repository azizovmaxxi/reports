/*
* Обработка отчета 2_1. Штаты, деятельность ГСВ
*/
...
function getReport(req, res){
  res.render('reports/rpt2_1/report_2_1');
}
  ...
  try
  {
    ...
    switch(getRole(req.user)){
      case 'lpu':
        ...
        break;
      case 'republic':
        throw "For current role don't report_2_1";
...
async function _lpu_report(req, res) {
  ...
  let sqlResult = await DB.EXEC_ASYNC("rpt_2_1", params.sqlParams);

  res.render('reports/rpt2_1/rpt_2_1_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
  getReport_2_1: getReport,
  resReport_2_1: resReport
};