...
function getReport(req, res){
  res.render('reports/rpt47/report_47');
}
...
async function _lpu_report(req, res) {
  ...
  // console.log(sqlResult.recordset);
  res.render('reports/rpt47/rpt_47_result', {layout: false, data: null, titleData: params.titleParams});
}
...
module.exports = {
  getReport_47: getReport,
  resReport_47: resReport
};