...
function getReport(req, res){
    res.render('reports/rpt33/report_33');
}
    ...
    try
    {
        ...
        switch(getRole(req.user)){
            case 'lpu':
                ...
                break;
            case 'republic':
                throw "For current role don't report_33";
...
async function _lpu_report(req, res) {
    ...
    let sqlResult = await DB.EXEC_ASYNC("rpt_33", params.sqlParams);

    res.render('reports/rpt33/rpt_33_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
    getReport_33: getReport,
    resReport_33: resReport
};