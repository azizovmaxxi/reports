...
function getReport(req, res){
  res.render('reports/rpt50/report_50');
}
...
async function _lpu_report(req, res) {
  ...
  let sqlResult = await DB.EXEC_ASYNC("rpt_50", params.sqlParams);
  res.render('reports/rpt50/rpt_50_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
  getReport_50: getReport,
  resReport_50: resReport
};