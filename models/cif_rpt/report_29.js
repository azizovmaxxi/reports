...
function getReport(req, res){
    res.render('reports/rpt29/report_29');
}
    ...
    try
    {
        ...
        switch(getRole(req.user)){
            case 'lpu':
                ...
                break;
            case 'republic':
                throw "For current role don't report_29";
...
async function _lpu_report(req, res) {
    ...
    let sqlResult = await DB.EXEC_ASYNC("rpt_29", params.sqlParams);

    res.render('reports/rpt29/rpt_29_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
    getReport_29: getReport,
    resReport_29: resReport
};