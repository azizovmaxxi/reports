...
function getReport(req, res){
  res.render('reports/rpt44/report_44');
}
...
async function _lpu_report(req, res) {
  ...
  let sqlResult = await DB.EXEC_ASYNC("rpt_44", params.sqlParams);

  res.render('reports/rpt44/rpt_44_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
  getReport_44: getReport,
  resReport_44: resReport
};