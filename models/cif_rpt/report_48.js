...
function getReport(req, res){
  res.render('reports/rpt48/report_48');
}
...
async function _lpu_report(req, res) {
  ...
  let sqlResult = await DB.EXEC_ASYNC("rpt_48", params.sqlParams);

  res.render('reports/rpt48/rpt_48_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
  getReport_48: getReport,
  resReport_48: resReport
};