...
function getReport(req, res){
    res.render('reports/rpt17/report_17');
}
    ...
    try
    {
        ...
        switch(getRole(req.user)){
            case 'lpu':
                ...
                break;
            case 'republic':
                throw "For current role don't report_17";
...
async function _lpu_report(req, res) {
    ...
    let sqlResult = await DB.EXEC_ASYNC("rpt_17", params.sqlParams);

    res.render('reports/rpt17/rpt_17_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
    getReport_17: getReport,
    resReport_17: resReport
};