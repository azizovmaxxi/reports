...
function getReport(req, res){
  res.render('reports/rpt51/report_51');
}
...
async function _lpu_report(req, res) {
  ...
  let sqlResult = await DB.EXEC_ASYNC("rpt_51", params.sqlParams);
  res.render('reports/rpt51/rpt_51_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
  getReport_51: getReport,
  resReport_51: resReport
};