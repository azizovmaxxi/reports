...
declare @last_name varchar(50) = 'Ра'

execute rpt_17 @sdate, @edate, @lpu_id,@lpu_parent_id

GO
IF OBJECT_ID ( 'rpt_17', 'P' ) IS NOT NULL DROP PROCEDURE rpt_17;

GO
CREATE PROCEDURE rpt_17 @sdate date, @edate date, @lpu_id INT, @lpu_parent_id INT
AS
BEGIN
    ...
    DECLARE @result_rpt_17 NVARCHAR(MAX) = '
    ...
    EXECUTE sp_executesql @result_rpt_17, N'@sdate date, @edate date, @lpu_id INT, @lpu_parent_id INT',
