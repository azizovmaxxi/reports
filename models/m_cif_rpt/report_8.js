...
function getReport(req, res){
    res.render('m_reports/rpt8/report_8');
}
    ...
    try
    {
        ...
        switch(getRole(req.user)){
            case 'lpu':
                ...
                break;
            case 'republic':
                throw "For current role don't report_8";
                break;
...
async function _lpu_report(req, res) {
    ...
    let sqlResult = await DB.EXEC_ASYNC("m_rpt_8", params.sqlParams);

    res.render('m_reports/rpt8/rpt_8_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
    getMReport_8: getReport,
    resMReport_8: resReport
};