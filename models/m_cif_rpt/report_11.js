/*
* Отчет - Назначен повторный визит
*/
...
function getReport(req, res){
    res.render('m_reports/rpt11/report_11');
}
...
async function _lpu_report(req, res) {
    ...
    let sqlResult = await DB.EXEC_ASYNC("m_rpt_11", params.sqlParams);

    res.render('m_reports/rpt11/rpt_11_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
    getMReport_11: getReport,
    resMReport_11: resReport
};