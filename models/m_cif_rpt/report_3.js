/*
* Отчет - Наблюдение по НИЗ(стар. 18 лет, кол. пациентов)
*/
...
function getReport(req, res){
    res.render('m_reports/rpt3/report_3');
}
...
async function _lpu_report(req, res) {
    ...
    let sqlResult = await DB.EXEC_ASYNC("m_rpt_3", params.sqlParams);

    res.render('m_reports/rpt3/rpt_3_result', {layout: false, data: sqlResult.recordset, titleData: params.titleParams});
}
...
module.exports = {
    getMReport_3: getReport,
    resMReport_3: resReport
};